...
function convertCardNumber(cardNo, machineType) {
    ...
    // Fixed byte5 ke 0x21 untuk konsistensi antar device (seperti mesin 1)
    // Ignore byte higher (>>24) agar tidak jadi 0x00 di nilai kecil seperti 2181712
    let byte5 = 0x21;
    ...
    console.log(`Converted card number ${cardNo} to ${formatted} for machine type ${machineType}`);
    console.log(`Bytes: byte5(fixed)=0x${byte5.toString(16)}, byte6=0x${byte6.toString(16)}, byte7=0x${byte7.toString(16)}, byte8=0x${byte8.toString(16)}`);
    return formatted;
}
