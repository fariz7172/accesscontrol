        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex">
                    <!-- Add Report Form -->
                    <form id="addReportForm" action="{{ route('absen.tambahLaporan') }}" method="POST" style="display: inline;">
                        @csrf
                    ...
                    <form id="searchForm" action="{{ route('absen.index') }}" method="GET" class="form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                ...
                <div class="card-body">
                    <form action="{{ route('absen.bulkAssign') }}" method="POST" id="bulkAssignForm">
                        @csrf
                        <div class="mb-3">
...
<script>
    // Konfigurasi global untuk JavaScript
    window.absenConfig = {
        shiftPatternUrl: "{{ url('/shift-pattern') }}",
        tambahLaporanUrl: "{{ route('absen.tambahLaporan') }}",
        exportUrl: "{{ route('absen.export') }}",
        recapUrl: "{{ route('absen.recap') }}",
        csrfToken: "{{ csrf_token() }}",
    };
</script>

<!-- Sekarang aman include JS eksternal -->
<script src="{{ asset('js/absen/absen.js') }}"></script>
