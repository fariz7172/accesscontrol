...
<head>
    ...
    <title>Soyal - Edit Leave Request</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="{{ route('member.update', $leaveProcess->Id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="leaveid" required>
                                        ...
                                        <option value="{{ $leaveType->Id }}" {{ $leaveProcess->leaveid == $leaveType->Id ? 'selected' : '' }}>
                                            {{ $leaveType->Name ?? 'Unnamed Leave Type' }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('leaveid')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="FromDate" value="{{ old('FromDate', \Carbon\Carbon::parse($leaveProcess->FromDate)->format('Y-m-d')) }}" required>
                                    @error('FromDate')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="ToDate" value="{{ old('ToDate', \Carbon\Carbon::parse($leaveProcess->ToDate)->format('Y-m-d')) }}" required>
                                    @error('ToDate')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
