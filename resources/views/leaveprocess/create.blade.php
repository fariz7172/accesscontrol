            ...
            <form action="{{ route('leaveprocess.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="EmplID" required>
                        ...
                        <option value="{{ $user->ID }}" {{ old('EmplID') == $user->ID ? 'selected' : '' }}>{{ $user->NAME }}</option>
                        @endforeach
                        @else
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="leaveid" required>
                        ...
                        <option value="{{ $leaveType->Id }}" {{ old('leaveid') == $leaveType->Id ? 'selected' : '' }}>{{ $leaveType->Name }}</option>
                        @endforeach
                        @else
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="FromDate" value="{{ old('FromDate') }}" required>
                    @error('FromDate')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
