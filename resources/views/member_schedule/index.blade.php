                            ...
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p><strong>Waktu:</strong> {{ \Carbon\Carbon::parse($availability->START_TIME)->format('H:i') }} - {{ \Carbon\Carbon::parse($availability->END_TIME)->format('H:i') }}</p>
                                        <form action="{{ route('member_schedule.book') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="BOOKED_AT" id="BOOKED_AT_{{ $availability->ID }}" class="form-control" value="{{ \Carbon\Carbon::parse($availability->END_TIME)->format('Y-m-d') }}" required>
                                            </div>
                                            <div class="form-group">
