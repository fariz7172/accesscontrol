...
use App\Exports\AttendanceOffDayExport; // Add new export class
...
class AttendanceSheetController extends Controller
{
            ...
            foreach ($dateRange as $date) {
                ...
                foreach ($employeeIds as $employeeId) {
                    ...
                    if ($attendRecord) {
                        ...
                        $shift = Shift::where('id', $user->ShiftCode)->first(); // Adjust based on your shift model and relationship
                        $dailyRecords->push((object)[
                            ...
                            'DayType' => null,
                            'userProfile' => $user,
                            'shift' => $shift, // Include shift if available
                            'leaveType' => null,
    ...
    public function updateRemark(Request $request)
    {
        ...
        if ($remarkData === 'N/A') {
            ...
            $attend->Remark = $remarkData; // Custom text
            $attend->DutyProcessID = null;
        }
    ...
    public function updateDutyProcess(Request $request)
    {
        ...
        try {
            ...
            if ($remarkData === 'N/A') {
                ...
                // Handle custom remark value
                $attend->Remark = $remarkData;
                $attend->DutyProcessID = null;
            }
